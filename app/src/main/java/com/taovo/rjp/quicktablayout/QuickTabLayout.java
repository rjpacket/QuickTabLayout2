...
import static com.taovo.rjp.quicktablayout.QuickTabLayout.NoticeMode.NOTICE_NUM;
import static com.taovo.rjp.quicktablayout.QuickTabLayout.TabMode.EQUANT;
import static com.taovo.rjp.quicktablayout.QuickTabLayout.NoticeMode.NOTICE_DOT;
...
public class QuickTabLayout extends LinearLayout {
     ...
     * 默认圆点提示
     */
    private NoticeMode noticeMode = NOTICE_DOT;
        ...
        switch (tabMode) {
            case EQUANT: //等分的情况下，过长或者tab过多都不去变换mode，有可能造成死循环
                ...
                for (int i = 0; i < tabCount; i++) {
                    ...
                    llTabContainer.addView(tab.getTabView());
    ...
    private void setSelectState() {
        ...
        tab.getTvNotice().setVisibility(GONE);
        tab.setNum("");
