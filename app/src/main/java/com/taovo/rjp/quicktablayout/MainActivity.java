...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabs1.add(new Tab("热点", "3"));
        tabs1.add(new Tab("视频视频"));
        tabs1.add(new Tab("体育"));
        tabs1.add(new Tab("图片图片", "5"));
        ...
        quickTabLayout1.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
        ...
        quickTabLayout2.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_NUM);
        ...
        quickTabLayout3.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
        ...
        tabs4.add(new Tab("图片新闻新闻新闻新闻", "3"));
        ...
        quickTabLayout4.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
        ...
        quickTabLayout6.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
        quickTabLayout6.setTabs(tabs6);

        ArrayList<Tab> tabs7 = new ArrayList<>();
        tabs7.add(new Tab("新闻"));
        tabs7.add(new Tab("热点", "9"));
        ...
        quickTabLayout7.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
        ...
        quickTabLayout8.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_NUM);
        ...
        quickTabLayout9.setNoticeMode(QuickTabLayout.NoticeMode.NOTICE_DOT);
